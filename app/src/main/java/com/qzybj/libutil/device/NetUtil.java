package com.qzybj.libutil.device;
...
public class NetUtil {
	...
	public static int getNetConnectSubType(Context context) {
		...
		if ((activeNetInfo != null) && activeNetInfo.isConnectedOrConnecting()) {
			...
			CLog.log("getNetConnectSubType: activeNetInfo.getType() = "+type);
			if (type == ConnectivityManager.TYPE_WIFI) {
				type = NETWORK_TYPE_WIFI;
				subtype = type;
				CLog.log("getNetConnectSubType: subtype = "+"NETWORK_TYPE_WIFI");
				...
				case TelephonyManager.NETWORK_TYPE_GPRS: // ~ 100 kbps
					...
					CLog.log("getNetConnectSubType: subtype = "+"NETWORK_TYPE_MOBILE_OTHER");
					break;
...
//				case TelephonyManager.NETWORK_TYPE_HSUPA:// ~ 1-23 Mbps
				case TelephonyManager.NETWORK_TYPE_UMTS:// ~ 400-7000 kbps
					...
					CLog.log("getNetConnectSubType: subtype = "+"NETWORK_TYPE_MOBILE_3G");
					 break;
				...
				default:
					...
					CLog.log("getNetConnectSubType: subtype = "+"NETWORK_TYPE_UNKNOWN");
                  break;
				}
			}
		}
		CLog.log("getNetConnectSubType:----- end ------");
		return subtype;
	}
